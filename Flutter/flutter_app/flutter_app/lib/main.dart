      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          tabs: <Widget>[
            ...
            Tab(icon: Icon(Icons.cached),text: "自绘",)
          ],
      ...
      body: TabBarView(
        ...
        children: <Widget>[
          UpdatedItemWidget(model: UpdatedItemModel(
            ...
            appName: "Google Maps - Transite & Fond",
            appSize: "137.2",
...
class UpdatedItemModel {
  ...
  String appVersion;
  UpdatedItemModel({this.appIcon,this.appSize,this.appDate,this.appDescription,this.appVersion,this.appName});
}
...
class UpdatedItemWidget extends StatelessWidget {
  ...
  Widget buildTopRow(BuildContext ctx) {
    return Row(
      children: <Widget>[
        Padding(
  ...
  Widget buildBottomRow(BuildContext ctx) {
    return Padding(
...
class WheelPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(boundingRect, radius * 2, radius, true, getColoredPaint(Colors.brown));
