...
{
    self.navigationController.preferredContentSize = CGSizeMake(self.view.bounds.size.width, sender.value);
}
...
- (IBAction)buttonPushAction:(UIButton*)sender
{
...
//    UINavigationController *nav = [[UINavigationController alloc]initWithRootViewController:secondViewController];
    ...
    [self.parentViewController.navigationController pushViewController:ThirdViewController animated:YES];
}
@end
