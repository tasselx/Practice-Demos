...
- (void)perform
{
    ...
    if([self.destinationViewController.childViewControllers[0] isKindOfClass:NSClassFromString(@"AAPLCustomPresentationFirstViewController")]){
        [self.sourceViewController.navigationController pushViewController:self.destinationViewController.childViewControllers[0] animated:YES];
    }else
